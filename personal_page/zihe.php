    ...
    <div class ="container">
      <div class="row pt-5">
        <div class="col-6 pt-5">
          <img src="../img/person/zihe_intro.JPG" class="img-thumbnail float-left" alt="Responsive image">
        </div>
        <div class="col-6 pt-5">
          ...
          <div class ="ptext_zijian_content">
            I’m a Master EE student at San Jose State focus on Machine Learning. Throughout my college years, I have developed strong interests in software engineering fields and have self-tought many programming skills. I've also tried to get my hands dirty by jump into many software projects to polish my skills. Now, I'm looking forward to a software engineer position that I can put my experiences in good use and exposure myself in a real-world workplace!
          </div>
        </div>
      </div>
    </section>
